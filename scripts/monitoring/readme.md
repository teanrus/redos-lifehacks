...
Интерактивный скрипт для настройки автоматического обновления системы по расписанию с настраиваемым временным окном (например, 12:30–14:00). Режимы: только проверка / безопасность / полное обновление. Гибкое расписание: ежедневно / будни / произвольные дни. Уведомления в Telegram.
