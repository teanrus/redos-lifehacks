#!/bin/bash
##############################################################################
# install-vipnet.sh — Установка ViPNet на РЕД ОС 7.3/8.0
#
# Описание: Установка ViPNet с выбором версии (Client или Client + Деловая почта)
#
# Использование:
#   sudo ./install-vipnet.sh [ОПЦИИ]
#
# Опции:
#   -h, --help           Справка
#   -w, --work-dir DIR   Рабочая директория (по умолчанию /tmp/vipnet)
...
# Рабочая директория (по умолчанию /tmp/vipnet)
WORK_DIR="/tmp/vipnet"
TAG_OVERRIDE=""
