#!/bin/bash
##############################################################################
# cleanup.sh — Очистка системы от временных файлов
#
# Описание: Безопасная очистка временных файлов, кэша, логов и неиспользуемых пакетов
#
# Использование:
#   sudo ./cleanup.sh [ОПЦИИ]
#
# Опции:
#   -h, --help            Справка
#       --non-interactive Не задавать вопросов, очистить всё
#       --skip-kernels    Пропустить удаление старых ядер
#       --skip-cache      Пропустить очистку кэша
#       --skip-logs       Пропустить очистку логов
#
