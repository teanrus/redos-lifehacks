...
- [📷 Подключение сканера](https://github.com/teanrus/redos-lifehacks/wiki/Scanner-Setup) — архитектура SANE (бэкенды/фронтенды), VID/PID, udev-правила, параметры `scanimage`, сетевое сканирование через `saned`
