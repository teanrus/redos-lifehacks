...
- [Проверка и настройка TRIM](#проверка-и-настройка-trim)
- [Оптимизация монтирования (fstab)](#оптимизация-монтирования-fstab)
- [Настройка планировщика ввода-вывода](#настройка-планировщика-ввода-вывода)
- [Управление swap на SSD](#управление-swap-на-ssd)
- [Оптимизация журналирования](#оптимизация-журналирования)
- [Настройка кэширования и temp](#настройка-кэширования-и-temp)
- [Мониторинг здоровья SSD](#мониторинг-здоровья-ssd)
- [Быстрая диагностика одним скриптом](#быстрая-диагностика-одним-скриптом)
