...
- [🚀 Настройка автодополнения в терминале](#-настройка-автодополнения-в-терминале)
  - [📋 Содержание](#-содержание)
  - [1. Базовое автодополнение в Bash](#1-базовое-автодополнение-в-bash)
  - [2. Продвинутое автодополнение в Zsh](#2-продвинутое-автодополнение-в-zsh)
  - [3. Умное автодополнение с описаниями](#3-умное-автодополнение-с-описаниями)
  - [4. Меню-дополнение (циклический перебор)](#4-меню-дополнение-циклический-перебор)
  - [5. Автоподсказки как в Fish](#5-автоподсказки-как-в-fish)
  - [6. Создание своих правил автодополнения](#6-создание-своих-правил-автодополнения)
  - [7. Скрипт диагностики](#7-скрипт-диагностики)
  - [🎯 Чек-лист](#-чек-лист)
  - [💡 Бонусные советы](#-бонусные-советы)
  - [⚠️ Возможные проблемы и решения](#️-возможные-проблемы-и-решения)
...
|----------|----------|
| **ОС** | РЕД ОС 7.3 / 8.0 |
| **Оболочки** | Bash, Zsh (опционально) |
| **Пакеты** | `bash-completion`, `zsh` (опционально) |
| **Совместимость** | ✅ РЕД ОС 7.x, ✅ РЕД ОС 8.x |

> [!note]
> В РЕД ОС 8.x пакет `bash-completion` обычно установлен по умолчанию. Для Zsh-плагинов требуется дополнительная настройка Oh My Zsh.
