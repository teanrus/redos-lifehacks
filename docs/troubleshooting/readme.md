...
### 🎨 [Проблемы с графикой в операционной системе РЕД ОС](/docs/troubleshooting/graphics-issues.md)
Графика: чёрный экран, низкое разрешение, тормоза интерфейса, драйверы NVIDIA, мерцание Intel, аппаратное ускорение видео, артефакты, яркость экрана

### 🔑 [Сброс связки ключей GNOME Keyring в РЕД ОС](/docs/troubleshooting/keyrings.md)
GNOME Keyring: сброс пароля связки, автоматическая разблокировка, потерянные пароли браузеров/Wi-Fi, Seahorse, проблемы с PAM
...
Миграция пользователей: перенос учётной записи, файлы и конфигурации, профили браузеров (Chrome, Firefox, Яндекс), GNOME Keyring, SSH-ключи, автоматический скрипт
