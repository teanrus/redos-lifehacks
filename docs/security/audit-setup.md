...
|----------|----------|
| **ОС** | РЕД ОС 7.3 / 8.0 |
| **Пакеты** | `audit`, `audispd-plugins` |
| **Права** | root (для настройки правил и просмотра логов) |
| **Совместимость** | ✅ РЕД ОС 7.x, ✅ РЕД ОС 8.x |

> [!note]
> В РЕД ОС 8.x auditd установлен по умолчанию. Для соответствия требованиям ФСТЭК настройте централизованный сбор логов и регулярную ротацию файлов аудита.