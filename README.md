...
---
[redos-setup](../redos-setup) — автоматизированный скрипт настройки АРМ РЕД ОС 7.3. Выполняет выборочную установку ПО с экономией трафика: базовая система (R7 Office, Яндекс.Браузер, ядро), мессенджеры (СРЕДА, Telegram), криптография (КриптоПро, Рутокен), ViPNet VPN, 1С:Предприятие.
 ---
