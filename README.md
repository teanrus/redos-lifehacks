...
<details>
<summary>redos-info.sh Сбор информации о системе (версия, ядро, пакеты)</summary>

Скрипт для автоматического сбора детальной информации о системе. Позволяет быстро получить полную картину состояния системы для диагностики, аудита или отчетности.
...
<details>
<summary>check-updates.sh Проверка доступных обновлений</summary>

</details>
<details>
<summary>disk-usage.sh Анализ использования дискового пространства</summary>

</details>
<details>
<summary>system-health.sh Проверка состояния системы</summary>
