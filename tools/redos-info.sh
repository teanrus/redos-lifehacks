...
#
# Описание: Комплексная диагностика системы: ОС, ядро, оборудование, диски, сеть, пакеты, сервисы
...
#   -d, --dir DIR       Директория для сохранения отчётов (по умолчанию: ./reports)
#
# Зависимости: bash, coreutils, systemd, rpm, dnf
# Опционально: smartmontools, bc
